...
using Tyuiu.KruchininEP.Sprint0.Task7.V0.Lib;
namespace Tyuiu.KruchininEP.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт # 0 | Выполнил: Кручинин Е. П. | РППб-25-1";
            Console.WriteLine("**************************************************************************************");
            ...
            if (arrayNums1.Length == arrayNums2.Length)
            {
                ...
                for (int i = 0; 1 < resultArray.Length; i++)
                {
